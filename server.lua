...
function extra_map_options:_on_required_loaded()
	...
	local scenario_selector = radiant.mods.require('stonehearth.services.server.world_generation.scenario_selector')
	local custom = require('services.server.world_generation.scenario_selector')
	radiant.mixin(scenario_selector, custom)
